...
Summary:<br>
:point_right: Kontext- & Use-Case-Diagramm einer selbstgeschriebenen Applikation oder einer Anwender aus Ihrem Arbeitsumfeld (Einzelarbeit);
...
- [ ] Dokumentieren Sie die Resultate in Ihrem **Github-Repo der Einzelarbeit**. Diagramme können Sie von Hand-Skizzieren und als Foto hochladen oder einen Editor nutzen benuzten (zB diagrams.net);
- [ ] Halten Sie sich bereit, Ihre Resultate der Klasse vorzustellen (<3');
- [ ] :date: Termin: Siehe [Hausaufgaben-Übersicht](Hausaufgaben.md).
